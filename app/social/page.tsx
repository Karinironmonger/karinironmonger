        ...
        <div style={{ "position": "relative", "maxWidth": "1180px", "margin": "0 auto", "padding": "0 clamp(22px,5vw,72px)" }}>
          ...
          <div data-reveal="200" style={{ "display": "flex", "flexWrap": "wrap", "gap": "18px 26px", "alignItems": "center", "margin": "clamp(30px,4vw,44px) 0 0" }}>
            ...
            <ul style={{ "listStyle": "none", "display": "flex", "flexWrap": "wrap", "gap": "8px", "margin": 0, "padding": 0 }}>
              <li><a href="https://www.linkedin.com/in/karinironmonger" target="_blank" rel="noopener" style={{ "display": "inline-flex", "alignItems": "center", "textDecoration": "none", "fontFamily": "'Martian Mono','Assistant',ui-monospace,monospace", "fontSize": "10px", "letterSpacing": ".09em", "textTransform": "uppercase", "color": "#F6F4F0", "border": "1px solid rgba(246,244,240,.22)", "borderRadius": "999px", "padding": "10px 16px", "transition": "background-color .25s ease,color .25s ease,border-color .25s ease" }} className="hv-3">LinkedIn</a></li>
